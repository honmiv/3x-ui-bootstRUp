// QR Code Generator - Lightweight client-side QR generation
// MIT License
(function(root, factory) {
            ...
            if (this.typeNumber < 1) {
                ...
                for (typeNumber = 1; typeNumber < 40; typeNumber++) {
                    ...
                    for (var i = 0; i < this.dataList.length; i++) {
                        ...
                        totalLength += QRUtil.getLengthInBits(data.mode, typeNumber);
                        totalLength += data.getLength() * 8;
                    }
                    if (totalLength <= totalDataCount * 8) break;
                }
    ...
    qrcode.generateSvgDataUrl = function(text, cellSize, margin) {
        var qr = new QRCode(0, 0); // Type 0 auto-detect, Level M
        qr.addData(text);
        qr.make();
