...
async def deploy_freedom_sub(
    ...
    resolved_proxy, resolved_freedom, extra_sub_env = ssh_deployer.resolve_sub_server_urls(
        "", freedom_sub_base,
    )
    fr_domain = target_domain or host or extract_domain_from_url(resolved_freedom)
